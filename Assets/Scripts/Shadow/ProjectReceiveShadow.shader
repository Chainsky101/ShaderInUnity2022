Shader "Unlit/ProjectReceiveShadow"
{
    Properties
    {
        // 材质颜色
    ...
    SubShader
    {
        // Base Pass -- this shadow just consider the shadow in base, without consider in the additional pass
        Pass
        {
            Tags
            {
        ...
        // Additional Pass -- cannot get the shadow from additional light
        Pass
        {
            Tags
            {
