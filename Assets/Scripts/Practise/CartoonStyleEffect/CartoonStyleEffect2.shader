    ...
    SubShader
    {
        ...
        Pass
        {
			...
			struct v2f
			{
				...
				SHADOW_COORDS(4)
				float3 vertexWorldPos : TEXCOORD5;
			};
			...
			{
				return UNITY_LIGHTMODEL_AMBIENT.rgb * albedo;
			}
			...
			{
				half spec = dot(semi_light_view, normalTangentDir);
